...
export default function Home_main() {
    return (
        <div className="home-main h-[110vh] w-[100vw] bg-background1 border border-background1 flex flex-row"> {/*for some reason, without the border, a margin-top comes for reasons i cannot comprehend*/}
            ...
            {/* <div> */}
                ...
                <div className="relative ml-[10vw] mt-[5vh] h-[75vh]">
                    <svg className='w-[100%]' width="390" height="109" viewBox="0 0 390 109" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M28.3595 25.413L41.2825 0H41.2825H52.0008V0.0154906L39.6419 25.413L52.0008 49.0785L41.2825 49.0785L28.3595 25.413Z" fill="#008F11" fill-opacity="0.9"/>
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M14 25.413L26.923 0H26.923H37.6413V0.0154906L25.2824 25.413L37.6413 49.0785L26.923 49.0785L14 25.413Z" fill="#008F11" fill-opacity="0.7"/>
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M0 25.413L12.923 0H12.923H23.6413V0.0154906L11.2824 25.413L23.6413 49.0785L12.923 49.0785L0 25.413Z" fill="#008F11" fill-opacity="0.52"/>
